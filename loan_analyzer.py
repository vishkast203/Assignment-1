...
print(f"The total value of loans is $", {total_loan_value})

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
Average_Loan_Amount = total_loan_value / number_of_loans
print(f"The average loan value is $", {Average_Loan_Amount})
...
# Print each variable.
print(Loan_Price,Remaining_Months,Repayment_Interval,Future_Value)   
...
def new_loan(future_value, remaining_months, annual_discunt_rate):
    present_value = future_value/(1+annual_discunt_rate/12)**remaining_months
    return present_value
    
# @TODO: Use the function to calculate the present value of the new loan given below.
#    Use an `annual_discount_rate` of 0.2 for this new loan calculation.
new_loan(future_value=1000 , remaining_months=12,annual_discunt_rate = 0.20) 
print(Present_Value)
